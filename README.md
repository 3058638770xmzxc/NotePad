...
- ![截图](screenshots/17.png)、screenshots/26.png
- 操作：
  1. 进入笔记编辑界面
  2. 点击设置图标
  3. 调整编辑页背景颜色
...
- ![截图](screenshots/5.png)、screenshots/4.png
...
![设置界面](screenshots/27.png)

### 背景设置

![背景设置](screenshots/28.png)
