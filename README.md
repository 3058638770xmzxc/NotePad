...
2. **输入笔记内容**
   - **截图**：![截图](screenshots/DQ]VL11US40[W)42~(L1@34.png)
   - 操作：在正文区域输入笔记内容
...
5. **保存笔记**
   - **截图**：![截图](screenshots/V2~{{}P`_7LFW$A`97YA[C9.png)
...
- **向左滑动**：隐藏笔记列表，显示空背景
  - **截图**：![截图](screenshots/JZ5C6}@4G]WK%B2{_{[)@13.png)
  - 操作：在主界面从右向左滑动
  - 效果：笔记列表向左滑出屏幕，只显示背景
  - **关键代码**：
    ```java
...
- **截图**：![截图](screenshots/F$L[FHZV0}G_MXIP(7V8G(8.png)、screenshots/RT%SON24_O5Y41R3]@7VBLI.png)
- 操作：
  1. 进入笔记编辑界面
  2. 点击设置图标
  3. 调整编辑页背景颜色
...
- **截图**：![截图](screenshots/_0Q4QTW3EOH[OF(J%0(JB76.png)、screenshots/]U$)B6DG(]S$ZLGOI{UWHOH.png)
